...
void main() {
  ...
  testWidgets('auto-scroll guard prevents snap-back after an unrelated mutation, but real currentIndex changes still scroll', (tester) async {
    final lines = [
      for (var i = 0; i < 5; i++)
        SubtitleLine(index: i, text: 'line $i', startMs: i * 1000, endMs: i * 1000 + 500),
    ...
    await tester.pumpAndSettle();
    expect(controller.offset, 0, reason: 'unrelated mutation should not re-trigger auto-scroll');
